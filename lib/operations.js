...
exports.loadPageTwoDat = function(pool,pageName){
    
    requestNormalWait = false;
    injectHtml(pageName,null,1);       

}



exports.loadPageThreeDat = function(pool,pageName,reqData){
    
    handleSql.shopsForDisplay(pool,[SchemaName.Shop.Schema,SchemaName.Shop.ImageSchema,SchemaName.Shop.numberSchema],"Name,Dynamic_Url,Email,description,Lat,Lon",null,null,pageName,10,function(shopsObj){
        console.log('loadPageThreeDat');
        requestNormalWait = false;
        
        calShopDist(reqData.latitude,reqData.longitude,shopsObj,function(newShopObj){
            injectHtml(pageName,newShopObj,1);
        });
...
exports.loadPageFourDat = (req,res,pool,bucket,datastore,dynamicUrl,absPath)=>{
    ...
    exports.sortPageName(absPath,function(pgName){
        ...
        if(pgName != undefined){
            ...
            handleSql.shopsForDisplay(pool,[SchemaName.Shop.Schema,SchemaName.Shop.ImageSchema,SchemaName.Shop.numberSchema],"Shop_Sub_Id,Name,Email,description,Address","Dynamic_Url",dynamicUrl,pgName,1,function(shopsObj){
