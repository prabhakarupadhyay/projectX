...
var strategy   = new GoogleStrategy({
  ...
  (accessToken, refreshToken, profile, done) => {
        process.nextTick(function() {
            ...
            sessionHandle.handleOauthSession(pool,extractProfile(accessToken, refreshToken, profile,'https://www.googleapis.com/plus/v1/people/me?access_token='),true,done);
        });
    });
...
function extractProfile (accessToken, refreshToken, profile,tokenReqUrl) {
